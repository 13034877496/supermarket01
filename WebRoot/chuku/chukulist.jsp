    ...
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#666666">
        <tr>
            <td height="30" background="../images/bg_list.gif">
                <div style="padding-left:10px; font-weight:bold; color:#FFFFFF">出库管理</div>
            </td>
        </tr>
        <tr>
            <td bgcolor="#FFFFFF">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                    ...
                    <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#F1F5F8'"
                        bgcolor="#FFFFFF">
                        <td height="15" class="td" width="8%"><%=rs.getString("ckid")%>
                        </td>
                        ...
                        <td height="15" class="td" width="8%"><%=rs.getString("ms")%>
                        </td>
                        <td height="15" class="td" width="8%"><%=rs.getString("czr")%>
                        </td>
                        <td height="15" class="td" width="8%"><%=rs.getString("cksj")%>
                        </td>
                        <td class="td" width="10%"><a href="chukuupdate.jsp?keyid=<%=rs.getString("ckid")%>">编辑</a> |<a
                                href="chukudelete.jsp?keyid=<%=rs.getString("ckid")%>"
                                onClick="javascript:if(confirm('是否删除')){return true;}else{return false;}">删除</a>|<a
                                href="chukudetail.jsp?keyid=<%=rs.getString("ckid")%>">查看</a></td>
                    </tr>
                                ...
                                <table width="98%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td align="right">当前页数：[<%=Page%>/<%=maxPage%>]&nbsp;
                                                <%if(Page>1){%>
                                            <a href="chukulist.jsp?Page=1">第一页</a>　<a
                                                    href="chukulist.jsp?Page=<%=Page-1%>">上一页</a>
                                                <% }
if(Page<maxPage){%>
                                            <a href="chukulist.jsp?Page=<%=Page+1%>">下一页</a>　<a
                                                    href="chukulist.jsp?Page=<%=maxPage%>">最后一页&nbsp;</a>
                                                <%}
