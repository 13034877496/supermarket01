            ...
            <td bgcolor="#FFFFFF">
                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                        ...
                        <td colspan="2" class="td">
                            <select name="gys">
                                <%
                                    ...
                                    while (rs.next()) {
                                %>
                                <option value="<%=rs.getString("gysmc")%>"><%=rs.getString("gysmc")%>
                                </option>
                                <% }%>
                    ...
                    <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#F1F5F8'"
                        ...
                        <td colspan="2" class="td"><input name="sl" placeholder="输入数量" type="text" value="0"
                                                          onKeyUp="this.value=this.value.replace(/\D/g,'')"/></td>
                    </tr>
                    <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#F1F5F8'"
                        bgcolor="#F1F5F8">
                        <td height="25" class="td">录入人 <font color="#FF0000">*</font></td>
                        <td colspan="2" class="td"><input name="lrr" placeholder="输入录入人" type="text"
                    ...
                    <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#F1F5F8'"
                        ...
                        <td colspan="2" class="td"><input name="zcsj" placeholder="输入注册时间" type="text"
                                                          value="<%=StaticMethod.getStringDate()%>" readonly=""/></td>
                    </tr>
