            ...
            <td bgcolor="#FFFFFF">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                    ...
                    <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#F1F5F8'"
                        ...
                        <td class="td" width="10%"><a href="rukudelete.jsp?keyid=<%=rs.getString("rkid")%>"
                                                      onClick="javascript:if(confirm('是否删除')){return true;}else{return false;}">删除</a>|<a
                                href="rukudetail.jsp?keyid=<%=rs.getString("rkid")%>">查看</a></td>
                    </tr>
                                ...
                                <table width="98%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td align="right">当前页数：[<%=Page%>/<%=maxPage%>]&nbsp;
                                                <%if(Page>1){%>
                                            <a href="rukulist.jsp?Page=1">第一页</a>　<a
                                                    href="rukulist.jsp?Page=<%=Page-1%>">上一页</a>
                                                <% }
if(Page<maxPage){%>
                                            <a href="rukulist.jsp?Page=<%=Page+1%>">下一页</a>　<a
                                                    href="rukulist.jsp?Page=<%=maxPage%>">最后一页&nbsp;</a>
                                                <%}
