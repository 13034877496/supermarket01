    ...
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#666666">
        <tr>
            <td height="30" background="../images/bg_list.gif">
                <div style="padding-left:10px; font-weight:bold; color:#FFFFFF">系统公告管理</div>
            </td>
        </tr>
        <tr>
            <td bgcolor="#FFFFFF">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                    ...
                    <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#F1F5F8'"
                        bgcolor="#FFFFFF">
                        <td height="15" class="td" width="8%"><%=rs.getString("xtggid")%>
                        </td>
                        <td height="15" class="td" width="8%"><%=rs.getString("bt")%>
                        </td>

                        <td height="15" class="td" width="8%"><%=rs.getString("fbsj")%>
                        </td>
                        <td class="td" width="10%"><a href="xtggupdate.jsp?keyid=<%=rs.getString("xtggid")%>">编辑</a> |<a
                                href="xtggdelete.jsp?keyid=<%=rs.getString("xtggid")%>"
                                onClick="javascript:if(confirm('是否删除')){return true;}else{return false;}">删除</a>|<a
                                href="xtggdetail.jsp?keyid=<%=rs.getString("xtggid")%>">查看</a></td>
                    </tr>
                                ...
                                <table width="98%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td align="right">当前页数：[<%=Page%>/<%=maxPage%>]&nbsp;
                                                <%if(Page>1){%>
                                            <a href="xtgglist.jsp?Page=1">第一页</a>　<a
                                                    href="xtgglist.jsp?Page=<%=Page-1%>">上一页</a>
                                                <% }
if(Page<maxPage){%>
                                            <a href="xtgglist.jsp?Page=<%=Page+1%>">下一页</a>　<a
                                                    href="xtgglist.jsp?Page=<%=maxPage%>">最后一页&nbsp;</a>
                                                <%}
