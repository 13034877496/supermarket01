...
<form name="form" action="" method="post">
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#666666">
        ...
        <tr>
            <td bgcolor="#FFFFFF">供应商名称&nbsp;&nbsp; <input type="text" name="gysmc"/>&nbsp;&nbsp;地址&nbsp;&nbsp; <input
                    type="text" name="dz"/>&nbsp;&nbsp;<input type=submit value="查询">
            </td>
        </tr>
    </table>
    ...
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#666666">
        <tr>
            <td height="30" background="../images/bg_list.gif">
                <div style="padding-left:10px; font-weight:bold; color:#FFFFFF">供应商管理</div>
            </td>
        </tr>
        <tr>
            <td bgcolor="#FFFFFF">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                    ...
                    <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#F1F5F8'"
                        ...
                        <td colspan="2">
                            <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                <tr>
                                    <td height="15" class="td" width="8%"><%=rs.getString("gysid")%>
                                    </td>
                                    <td height="15" class="td" width="8%"><%=rs.getString("gysmc")%>
                                    </td>
                                    <td height="15" class="td" width="8%"><%=rs.getString("dz")%>
                                    </td>
                                    <td height="15" class="td" width="8%"><%=rs.getString("jyfw")%>
                                    </td>
                                    <td height="15" class="td" width="8%"><%=rs.getString("dh")%>
                                    </td>
                                    <td height="15" class="td" width="8%"><%=rs.getString("fr")%>
                                    </td>
                                    <td height="15" class="td" width="8%"><%=rs.getString("zcsj")%>
                                    </td>
                                    <td class="td" width="10%"><a href="gysdetail.jsp?keyid=<%=rs.getString("gysid")%>">查看</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
